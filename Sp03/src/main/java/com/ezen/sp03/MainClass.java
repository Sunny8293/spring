...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 스프링 프레임워크에서는 클래스의 운용방식이 위와 같지않고, 정의된 클래스의 new인스턴스를
		...
		// 레퍼런스 변수를 선언하고, 스프링 컨테이너에서 객체를 꺼내서 선언된 레퍼런스 변수에 저장합니다
		...
		// 차이점을 굳이 써본다면, new 인스턴스를 사용하면 사용할 때마다 새로운 인스턴스가 생성도는 반면
		// getBean()은 싱글턴 방식처럼 하나의 생성된 객체가 계속 사용된다는 점이 다릅니다
		// getBean()으로 같은 클래스의 서로 다른 인스턴스를 두개 사용해야 한다면, 다른 id값으로 Bean을
		// 두개 추가하여 사용합니다.
